...
const NAV = `<header class="public-header-v25"><div class="public-nav-v25">
  ...
  <nav class="public-links-v25 nav-links" id="navLinks" aria-label="Navegación principal"><a href="../index.html">Inicio</a><a class="active" href="../servicios.html">Servicios</a><a href="../compra-segura.html">Compra segura</a><a href="../faq.html">Preguntas</a><a href="../cliente.html">Garage</a><a class="public-nav-cta-v25" href="../agenda.html">Agendar</a></nav>
</div></header>`;
...
const NAV_MOVIL = `<nav class="public-mobile-nav-v25" aria-label="Navegación móvil"><a href="../index.html"><small>Inicio</small></a><a class="active" href="../servicios.html"><small>Servicios</small></a><a href="../compra-segura.html"><small>Compra segura</small></a><a href="../agenda.html"><small>Agendar</small></a><a href="../cliente.html"><small>Garage</small></a></nav>`;
