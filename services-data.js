...
// PIN local para administrar estados. NO es seguridad real de producción; solo restringe la interfaz local.
// En producción esto debe moverse a login real con backend/Supabase/Netlify Identity.
...
const dtekFaqs = [
  ...
  ["¿Los precios son finales?", "Son precios desde. Materiales, distancia, complejidad, acceso y tipo de vehículo pueden cambiar el total."],
...
const dtekBookingSettings = {
  ...
  "check-engine-escaneo-explicado": { durationMinutes: 45, bufferBefore: 15, bufferAfter: 30, directBooking: true },
  "escaneo-datos-vivo": { durationMinutes: 60, bufferBefore: 30, bufferAfter: 30, directBooking: true },
  "compra-segura": { durationMinutes: 90, bufferBefore: 30, bufferAfter: 45, directBooking: true },
  "compra-segura-avanzada": { durationMinutes: 150, bufferBefore: 45, bufferAfter: 60, directBooking: true },
  "diagnostico-pro": { durationMinutes: 120, bufferBefore: 30, bufferAfter: 45, directBooking: true },
  "aprendizajes-calibraciones-simples": { durationMinutes: 60, bufferBefore: 15, bufferAfter: 30, directBooking: true },
  ...
  "inyeccion-admision-consulta": { durationMinutes: 90, bufferBefore: 30, bufferAfter: 45, directBooking: true },
  "limpieza-cuerpo-aceleracion": { durationMinutes: 75, bufferBefore: 30, bufferAfter: 30, directBooking: true },
  "limpieza-admision": { durationMinutes: 120, bufferBefore: 30, bufferAfter: 45, directBooking: true },
  "limpieza-inyectores-gasolina": { durationMinutes: 120, bufferBefore: 30, bufferAfter: 45, directBooking: true },
